...
public class SHA2_OP extends SHA {
	...
	//changing these to static finals seemed to make a big difference in the SHA3. It does not make a lot of difference here
	...
	//the major changes I made were to unroll the methods and only initialize the variables that I need. Also by eliminating the
	//array I am hoping to reduce time to reference the value
	private void processBuffer() {
		...
		//I use the same counter for all of the loops. That way I only create it once
		//instead of 3 seperate times. Also I only have to assign it a value twice
		for (i = 0; i < 16; i++) {
	...
	//This code is the same as the non optimized version
